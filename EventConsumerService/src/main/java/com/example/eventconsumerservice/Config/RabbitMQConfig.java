...
public class RabbitMQConfig {
    ...
    public Queue directQueue() {
        return QueueBuilder.durable(rabbitMQProperties.queue().notifications())
                .withArgument("x-dead-letter-exchange", rabbitMQProperties.exchange().dlx())
                .withArgument("x-dead-letter-routing-key", rabbitMQProperties.queue().dlxNotifications())
    ...
    public Queue dlxQueue() {
        return QueueBuilder.durable(rabbitMQProperties.queue().dlxNotifications()).build();
    }
    ...
    public Binding dlxBinding(Queue dlxQueue, DirectExchange dlxExchange) {
        return BindingBuilder
                .bind(dlxQueue)
                .to(dlxExchange)
                .with(rabbitMQProperties.queue().dlxNotifications());
    }
